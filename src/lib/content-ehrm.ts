  ...
  lectures: [
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correct: [1, 2],
          explanation:
            'Formal objectives are the top-level goals of HRM, divided into economic objectives (optimal use of personnel, increasing work performance through incentives) and social objectives (meeting the interests and expectations of individual employees regarding pay and working conditions). Providing HR capacity in the required quantity and quality at the right time and location describes the primary tactical objective — the "how" that delivers formal goals. Standardizing HR processes through defined roles and documented workflows describes process standardization, which is not a formal HRM objective category.',
        },
        {
          id: 'L1Q3',
          conceptIndex: 5,
        ...
        },
        {
          ...
          correct: [1],
          explanation:
            'The precise definition of e-HRM emphasizes three key characteristics: (1) web-based and interactive, (2) real-time information availability, and (3) access from anywhere through a web browser — for both organizational administrators and individual employee end-users. Describing e-HRM as merely any electronic device for record storage, as automation of payroll and accounting processes alone, or as digitalized job advertisement placement all represent narrower or earlier forms of HR IT adoption that do not capture the full scope of e-HRM.',
        },
        {
          id: 'L1Q7',
          conceptIndex: 7,
          ...
          correct: [1, 2],
          explanation:
            'Research (Weitzel et al., 2020) confirms a statistically significant positive correlation between the process-standardization score and the digitalization score across both Top-1,000 and IT companies. The practical conclusion is that a strong focus on defining and improving HR processes precedes and enables effective digitalization. The claim that investing in HR technology automatically raises process standardization reverses the causal relationship. The claim that process standardization is only relevant in IT companies is incorrect — the positive correlation is observed across both sectors.',
        },
      ],
      flashcards: [
        {
...
- **Employee self-service** — temporary read access rights for employees to inspect their own records
    ...
    These factors are interdependent: a lack of top-management support amplifies resource shortages; inadequate change management deepens technology resistance. Organizations that address all five factors holistically are significantly more likely to realize the full value of their HRIS investments.`,
      ...
      questions: [
        ...
        },
        {
          ...
          correct: [1, 3],
          explanation: `The authoritative HRIS definition (Pilarski 2016) specifies **personal data** — individual employee data — as the object of an HRIS, not corporate financial aggregates. Operating as a stand-alone system independent of other enterprise systems is incorrect: HRIS are closely integrated with other systems, particularly accounting systems for compensation management and production planning systems for personnel deployment. The correct statements are that an HRIS collects, stores, processes, and displays personal data (restating the definition precisely), and that a single HRIS can serve operational, middle-management, and strategic purposes simultaneously — administration support systems at the operative level, MIS/DSS at middle management, and ESS at the strategic level.`,
        },
        {
          id: 'L2Q6',
          conceptIndex: 5,
        ...
        },
        {
          ...
          correct: [2, 3],
          explanation: `Employers are not legally required to maintain personnel files at all, let alone in a specific format — the choice of medium (paper or digital) is entirely at the employer's discretion. The claim that file content is legally unrestricted is incorrect: content is restricted to information the employer has legitimately acquired and for which there is a legitimate interest; excessive data collection is not permitted. The "quality of evidence" problem is the most cited legal disadvantage, sometimes necessitating parallel paper archives for critical documents. Research by tutum GmbH and the University of Bamberg confirmed that 88% of organizations reported improved employee data access, 70–76% reported better data security and reduced data loss, and most organizations saved 1–5 hours of administrative work per week.`,
        },
      ],
      flashcards: [
        {
      ...
      questions: [
        {
          ...
          correct: [1],
          explanation:
            'Business process management (BPM) operates at the technical-conceptual level: it analyses and designs processes in alignment with business strategy — answering "what" must happen. Workflow management operates at the operational level: it specifies in detail how each task is executed, including routing rules, technology use, and role assignments — answering "how" it happens. The other options each reverse or conflate this relationship — claiming both disciplines operate at the operational level, that workflow management is strategic, or that process management specifies task execution — all of which are incorrect.',
        },
        {
          id: 'L3Q2',
          conceptIndex: 1,
    ...
    **Five ethical guidelines for ESM network analysis:** Network position data can disadvantage specific employees, so HRM must balance insight accuracy against employee safety. Five principles govern any ESM network study:
    ...
    What is the degree centrality of employee E2?`,
        ...
        },
        {
          ...
          correct: [1, 3],
          explanation: `Two of the five ethical guidelines are reflected here: (2) anonymization and aggregation — individual data must be protected by anonymizing or aggregating results, so no employee can be identified from reported findings; and (4) true opt-out option — every employee has the unconditional right to exclude themselves. The remaining three options violate the guidelines: requiring all employees to participate violates the principle of uncoerced participation; sharing each employee's individual network position report directly with their line manager violates the respondent give-back principle, which requires individualized feedback to be delivered through a neutral third-party intermediary; and conducting the network analysis without informing employees in advance violates the pre-study consent requirement.`,
        },
      ],
      flashcards: [
        {
      ...
      questions: [
        {
          ...
          correct: [2],
          explanation:
            'Basic (must-be) characteristics are taken entirely for granted. Fulfilling them does NOT generate high satisfaction — the reaction is neutral because candidates simply assumed they would be present. However, their absence causes strong dissatisfaction. This is the hygiene-factor logic: basic characteristics can only prevent dissatisfaction, they cannot actively create it. The claim that full implementation generates high satisfaction is wrong — it leads to a neutral reaction. The claim that absence leaves candidates neutral describes excitement characteristics, not basic ones. The claim that basic and performance characteristics behave identically is wrong — performance characteristics scale linearly while basic ones plateau at neutral.',
        },
        {
          id: 'L5Q2',
          conceptIndex: 3,
          ...
          correct: [0, 2],
          explanation:
            "Basic characteristics are those that candidates take entirely for granted — their presence does not delight but their absence causes dissatisfaction. An automated acknowledgement email confirming receipt of an application and a legally compliant employment contract provided before the start date are standard baseline expectations that no employer can omit without serious reputational harm. A performance bonus that grows in direct proportion to individual output and a faster interview scheduling process than the industry average improve satisfaction proportionally as they increase — these are performance characteristics. An unexpected personalized welcome kit delivered to the candidate's home is a surprise the candidate did not expect, making it an excitement/delighter characteristic.",
        },
        {
          id: 'L5Q3',
          conceptIndex: 3,
          ...
          correct: [0, 3],
          explanation:
            'Performance (one-dimensional) characteristics follow a linear "the more, the better" logic: satisfaction rises as fulfillment increases and falls as fulfillment decreases. The speed of interview feedback and the size of the annual learning and development budget are classic examples — both exhibit this proportional relationship. Canteen access and a minimum legal notice period are taken-for-granted basics whose presence creates neutral reactions. An immersive VR job preview offered only to final-round candidates is an unexpected feature that creates enthusiasm — an excitement/delighter characteristic.',
        },
        {
          id: 'L5Q4',
          conceptIndex: 7,
        ...
        },
        {
          ...
          correct: [1, 2],
          explanation:
            'Two established disadvantages of gamification in HRM are: the high cost and development complexity — game-based assessments require extensive testing, psychometric validation, and multi-skill measurement infrastructure; and limited empirical evidence — the science on whether game elements consistently improve the predictive validity of assessments over the long run is still developing. The claim that gamified tools are consistently perceived more negatively by candidates is incorrect: research and practice show gamification typically improves candidate perceptions. The claim that gamification makes it impossible to measure personality traits is false — gamified tools can and do measure personality traits such as learning speed and social skills. The claim that gamification eliminates the ability to compare candidates is incorrect — scoring and comparison remain possible within gamified systems.',
        },
        {
          id: 'L5Q7',
          conceptIndex: 6,
          ...
          correct: [2],
          explanation:
            'Disparate treatment is intentional discrimination: a decision-maker consciously uses a protected characteristic (race, religion, gender, age, political views, etc.) when making an employment decision. The scenario describes exactly this — the manager deliberately factors in ethnicity and political views visible on social media. Disparate impact describes unintentional structural bias where a neutral-looking process systematically disadvantages a protected group — a different situation from conscious use of protected characteristics. Privacy concerns are also present in this scenario, but the most precise legal concept for this form of conscious discrimination is disparate treatment.',
        },
      ],
      flashcards: [
        {
    ...
    Companies such as Google, Credit Suisse, and Xerox use data-driven machine-learning models to flag at-risk employees early and propose personalized countermeasures (salary adjustments, promotions, targeted retraining). However, a critical caution applies: **biased training data produces biased AI predictions.** Amazon's scrapped recruiting AI — trained on male-dominated historical resumes — systematically disadvantaged female applicants, demonstrating that data-driven approaches still require theoretical grounding and ethical oversight. In HR, one must define "truth" first before searching for it in data.`,
      ...
      questions: [
        ...
        },
        {
          ...
          correct: [2],
          explanation:
            "Job Embeddedness Theory argues that employees stay because they are embedded in a web defined by Fit (how well values, skills, and plans match the job and community), Links (the strength and number of connections to people and groups), and Sacrifice (the perceived cost of giving those up by leaving). These three dimensions are assessed across both the job context and the broader community context. 'Desire to move, ease of movement, and met expectations' describes components of March & Simon's organizational equilibrium theory, and 'Shock, image violation, and evaluation of job alternatives' describes Lee & Mitchell's unfolding model — both are voluntary turnover theories, not job embeddedness.",
        },
      ],
      flashcards: [
        {
    ...
    **Worked example — MAE and MSE (4 predictions):**
    ...
    | $i$ | $p_i$ | $r_i$ | $\\lvert p_i - r_i \\rvert$ | $(p_i - r_i)^2$ |
    |---|---|---|---|---|
    | 1 | 4 | 5 | 1 | 1 |
    | 2 | 3 | 1 | 2 | 4 |
    | 3 | 2 | 3 | 1 | 1 |
      ...
      questions: [
        {
          ...
          correct: [1],
          explanation:
            "The definition states: the recommendation seeker receives a recommendation from the universe of alternatives; the recommender uses information about the user's preferences AND similarities to other users. Presenting the single best item identically to every user is wrong — recommendations are personalized. Requiring ratings from the active user only is wrong — collaborative filtering explicitly uses other users' data. The claim that recommender systems operate exclusively in B2C contexts is wrong — they are widely applied in B2E and HRM scenarios.",
        },
        {
          id: 'L7Q2',
          conceptIndex: 6,
        ...
        },
        {
          ...
          correct: [0, 2],
          explanation:
            "Collaborative filtering can recommend any type of object — including complex ones like teams or people — because it only needs user ratings, not content attributes. It also avoids overspecialization: because similarity is between users rather than content, it can cross category boundaries and recommend something genuinely new. The claim that it is fully transparent is wrong — collaborative filtering is a black box and cannot explain which content features caused the recommendation. The claim that it handles new items immediately is wrong — it suffers from the New Item cold-start problem. The claim that it requires only the active user's own ratings is wrong — it relies on ratings from all users.",
        },
        {
          id: 'L7Q7',
          conceptIndex: 7,
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correct: [1],
          explanation:
            'Training focuses on the planned acquisition of knowledge, skills, and abilities (KSA) needed to perform specific current tasks — it is organizationally directed, near-term, and measured by participation rates and course completion. Learning is a cognitive process of assimilation driven by the individual, oriented toward future roles and life-long competency development, and measured by actual behavior change and knowledge application. The option describing training as future-focused and learning as task-specific, and the option calling learning an administrative function while training is self-directed, each reverse the defining characteristics of the two concepts.',
        },
        {
          id: 'L8Q7',
          conceptIndex: 6,
          ...
          correct: [0, 2],
          explanation:
            'The five key LMS features are: (1) authoring tools to create courses, (2) tracking and reporting learner progress, (3) online classrooms and discussion forums for interaction, (4) assessment creation and assignment tools, and (5) integration links with other HCM systems. Tracking learner progress and providing authoring tools directly correspond to two of these features. Automatically generating annual performance ratings linked to salary decisions describes an e-compensation or performance management function, not an LMS capability. Replacing the core HRIS with an employee database and scheduling face-to-face sessions with physical attendance tracking do not correspond to any defined LMS feature.',
        },
      ],
      flashcards: [
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correct: [0, 2],
          explanation:
            'The study identified four significant drivers of intent to use gamified self-assessment tools: perceived ease of use, perceived usefulness, **perceived enjoyment**, and **perceived selection fairness**. Of the five options, only perceived enjoyment and perceived selection fairness appear in this list. **Perceived privacy security was not a significant predictor** — a notable counter-intuitive finding. Perceived social influence from the recruiting firm and perceived anonymity within the game environment were not constructs examined in this specific model.',
        },
        {
          id: 'L9Q7',
          conceptIndex: 3,
